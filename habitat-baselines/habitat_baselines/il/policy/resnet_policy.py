...
from habitat_baselines.il.encoders.resnet_encoders import (
    VlnResnetDepthEncoder,
    ResnetRGBEncoder,
    ResnetSemSeqEncoder,
)
from habitat_baselines.il.models.rnn_state_encoder import RNNStateEncoder
from habitat_baselines.common.baseline_registry import baseline_registry
from habitat_baselines.rl.ppo import Net, Policy, NetPolicy
# from habitat_baselines.rl.ppo import Net
# from habitat_baselines.il.policy.policy import Policy
...
class ObjectNavILNet(Net):
    ...
    def __init__(self, observation_space: Space, model_config, num_actions, device=None):
        super().__init__()
...
class ObjectNavILPolicy(NetPolicy):
    def __init__(
        self, observation_space: Space, action_space: Space, model_config
    ):
        super().__init__(
            ObjectNavILNet(
    ...
    # def act(self, observations, rnn_hidden_states=None, prev_actions=None, masks=None, **kwargs):
